...
<header class="topbar">
  ...
  <div class="top-right">
    <div class="year-pill"><span class="dot"></span><?= $annee['dateannee'] ?></div>
    ...
    <div class="user">
      ...
      <div class="user-meta">
        <div class="user-name"><?= $user['prenom']." ".$user['nom_sup'] ?></div>
        <div class="user-role"><?= $user['nom_role'] ?></div>
      </div>
    </div>
     <a href="http://localhost:9000/logout" class="btn btn-primary" id="saveBtn" style="text-decoration:none" >
        Deconnexion
    </a>
  </div>
</header>
...
<div class="page">
  ...
  <form method="POST" action="http://localhost:9000/lister" class="filters-card" id="filtersCard">
    <div class="field">
      ...
      <div class="select-wrap">
        ...
        <?php foreach($classes as $classe):?>
          <option value="<?= $classe['id'] ?>"><?= $classe['nom_class'] ?></option>
          <?php endforeach ?>
        </select>
